  ...
  if (activeTab === 'overview') {
    ...
    const simulationContent = el(
        ...
        simRows.map((r) =>
          el(
            ...
            el(
              ...
              el('span', { className: 'font-bold text-emerald-500' }, `$${Math.round(r.estYearly).toLocaleString()}`)
            )
          )
        )
      ),
      el(
        ...
        el('span', { className: 'text-lg font-bold text-emerald-500' }, `$${Math.round(totalEst).toLocaleString()}`)
      )
    );
